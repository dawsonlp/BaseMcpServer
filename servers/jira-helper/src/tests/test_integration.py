...
from domain.models import (
    ...
    JiraInstance, WorkflowGraph, WorkflowNode, WorkflowEdge
)
from domain.exceptions import JiraValidationError, JiraDomainException, JiraConfigurationMissingError
...
class TestGraphvizGenerator:
    ...
    def test_generate_svg_graph(self, graph_generator, sample_workflow_graph):
        ...
        with patch('infrastructure.graph_generator.graphviz') as mock_graphviz:
            ...
            result = graph_generator.generate_svg(sample_workflow_graph)
    ...
    def test_generate_png_graph(self, graph_generator, sample_workflow_graph):
        ...
        with patch('infrastructure.graph_generator.graphviz') as mock_graphviz:
            ...
            result = graph_generator.generate_png(sample_workflow_graph)
