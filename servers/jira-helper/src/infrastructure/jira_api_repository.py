...
from domain.exceptions import (
    ...
    JiraPermissionError, JiraCommentError, JiraAssigneeError, JiraWorkflowError
)
...
class JiraApiRepository(BaseJiraAdapter, JiraRepository):
    ...
    def _convert_project_to_domain(self, project, instance_name: Optional[str] = None) -> JiraProject:
    ...
    def _build_search_jql(self, project_key: str, status: Optional[str] = None, issue_type: Optional[str] = None) -> str:
