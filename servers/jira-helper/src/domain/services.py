...
from .ports import (
    ...
    IssueCreationPort, LinkTypeMapper, JQLValidator, TimeTrackingPort,
    TimeFormatValidator
)
from .exceptions import (
    ...
    JiraGraphLibraryNotAvailable, InvalidLinkTypeError, CircularLinkError,
    InvalidJQLError, IssueUpdateError, IssueLinkError, LinkNotFoundError,
    JQLSecurityError, SearchLimitExceededError, EpicLinkError,
    LinkTypeNotSupportedError, IssueFieldUpdateError, ConcurrentUpdateError,
...
class IssueLinkService:
    ...
    async def get_issue_links(self, issue_key: str, instance_name: Optional[str] = None) -> List[IssueLink]:
...
class IssueUpdateService:
    ...
    async def validate_update_permissions(self, issue_key: str, fields: Dict[str, Any], instance_name: Optional[str] = None) -> List[str]:
